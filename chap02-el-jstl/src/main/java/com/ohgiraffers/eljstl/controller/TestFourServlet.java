...
public class TestFourServlet extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		MemberDTO sessionMember = new MemberDTO("돼지", 200, "010-1111-1111", "pig@ohgiraffers.com");
		MemberDTO requestMember = new MemberDTO("다람쥐", 900, "010-2222-2222", "squirrel@ohgiraffers.com");
